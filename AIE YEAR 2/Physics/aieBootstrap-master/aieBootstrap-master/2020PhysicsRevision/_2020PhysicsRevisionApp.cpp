...
_2020PhysicsRevisionApp::_2020PhysicsRevisionApp() {
...
bool _2020PhysicsRevisionApp::startup() {
...
void _2020PhysicsRevisionApp::shutdown() {

	delete m_font;
	delete m_2dRenderer;
}

void _2020PhysicsRevisionApp::update(float deltaTime) {
	...
	//draw the ball
	aie::Gizmos::add2DCircle(glm::vec2(0, x), 3, 12, glm::vec4(1, 1, 0, 1));
...
void _2020PhysicsRevisionApp::draw() {
